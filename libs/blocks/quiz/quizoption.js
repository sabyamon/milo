...
export const OptionCard = ({ text, title, coverImage, cardIcon, options, disabled, selected}) => {
...
export const CreateOptions = ({ options, handleCardSelection, selectedCards, countSelectedCards = 0, maxSelections, getOptionsIcons }) => {
  return html `
 ...
 export const GetQuizOption = ( { btnText, options, minSelections, maxSelections, selectedCards, handleOnNextClick, onOptionClick, countSelectedCards, getOptionsIcons } ) => {
  return html `
